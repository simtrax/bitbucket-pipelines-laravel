...
RUN \
  ...
  apt-get install -y php7.3 php7.3-cli php7.3-common php7.3-curl php7.3-dev php7.3-fpm php7.3-json php7.3-bcmath php7.3-mbstring php7.3-mcrypt \
    php7.3-mysql php7.3-opcache php7.3-readline php7.3-sqlite3 php7.3-xml php7.3-zip php7.3-intl php7.3-gd php-mongodb php-xdebug && \
